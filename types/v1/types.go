...
// SdtIPList defines struct for SdtIPList
type SdtIPList struct {
	SdtIP SdtIP `json:"SdtIp"`
}

// SdtParam defines struct for SdtParam
type SdtParam struct {
	Name               string       `json:"name,omitempty"`
	IPList             []*SdtIPList `json:"ips"`
...
// SdtAddIPParam defines the struct for adding IP for the sdt
type SdtAddIPParam SdtIP
